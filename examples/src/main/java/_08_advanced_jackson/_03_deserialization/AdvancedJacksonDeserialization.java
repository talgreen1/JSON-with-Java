package _08_advanced_jackson._03_deserialization;

import _02_serialization_and_deserialization.Person;
import _08_advanced_jackson._03_deserialization.model.Person1;
...
public class AdvancedJacksonDeserialization {
    ...
    private static void differentFieldName() throws IOException {
        ...
        _08_advanced_jackson._03_deserialization.model.Person person;

        try {
            person = mapper.readValue(json, _08_advanced_jackson._03_deserialization.model.Person.class);
