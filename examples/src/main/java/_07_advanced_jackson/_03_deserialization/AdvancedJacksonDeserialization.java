package _07_advanced_jackson._03_deserialization;

import _02_serialization_and_deserialization.Person;
import _07_advanced_jackson._03_deserialization.model.Person1;
...
public class AdvancedJacksonDeserialization {
    ...
    private static void differentFieldName() throws IOException {
        ...
        _07_advanced_jackson._03_deserialization.model.Person person;

        try {
            person = mapper.readValue(json, _07_advanced_jackson._03_deserialization.model.Person.class);
