...
public class Exe_02_Test {

    @Rule
    public TemporaryFolder folder= new TemporaryFolder();

    private static Exe_02 answer;
    ...
    @Test
    public void exe_02_test_3_cars() throws IOException {
    ...
    @Test
    public void exe_02_test_4_cars() throws IOException {
        File file = folder.newFile("testFile.json");
    ...
    @Test
    public void exe_02_test_2_cars() throws IOException {
        File file = folder.newFile("testFile.json");
    ...
    @Test
    public void exe_02_test_no_cars() throws IOException {
        File file = folder.newFile("testFile.json");
